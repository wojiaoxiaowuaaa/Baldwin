...
from config.setting import douyin
...
# 计算指定文件夹的大小
folder_size = sum([os.path.getsize(os.path.join(root, filename)) for root, dir, filenames in os.walk('/Users/wl/go') for filename in filenames])
